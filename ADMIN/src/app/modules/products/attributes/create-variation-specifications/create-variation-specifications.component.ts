...
export class CreateVariationSpecificationsComponent {
  ...
  save() {
    ...
    this.attributeService.createSpecification(data).subscribe((resp:any) => {
      ...
      if (resp.message == 403) {
        ...
        this.toastr.success('Guardado', 'Especificación guardada correctamente');
  ...
  saveVariation() {
    ...
    if (this.precio_add < 0) {
      this.toastr.error('Validacion', 'El precio no puede ser menor a 0');
      return;
    }

    if (this.stock_add <= 0) {
      this.toastr.error('Validacion', 'El stock no puede ser menor a 0');
      return;
    }
    ...
    this.attributeService.createVariations(data).subscribe((resp:any) => {
      ...
      if (resp.message == 403) {
        ...
        this.toastr.success('Guardado', 'Variación guardada correctamente');
