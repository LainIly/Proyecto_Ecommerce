...
class CategorieController extends Controller
{
     ...
     */
    public function destroy(string $id) //Recomendacion: No borrar o validar la Categoria si ya se le ha asignado un producto. 
    {
        $categorie = Categorie::findOrFail($id);
        ...
        if ($categorie->product_categorie_firsts->count() > 0 ||
            ...
            $categorie->product_categorie_thirds->count() > 0) {
                return response () -> json(['message' => 403, 'message_text' => 'No se puede eliminar la categoria porque ya tiene productos asignados']);
        }
