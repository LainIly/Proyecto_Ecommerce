...
class ProductController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        $products = Product::filterAdvanceProduct($search,$categorie_first_id, $categorie_second_id, $categorie_third_id, $brand_id)->orderBy('id', 'desc')->paginate(25);
    ...
    public function store(Request $request)
    {
        ...
        if ($isValid) {
            return response()->json([
                'message' => 403, 'message_text' => 'El producto ya existe',
            ]);
        }
